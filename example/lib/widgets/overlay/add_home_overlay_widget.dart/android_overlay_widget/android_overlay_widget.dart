...
class AndroidOverlayWidget extends StatefulWidget {
  final Function close;
  const AndroidOverlayWidget({
    required this.close,
    super.key,
  });

  @override
  State<AndroidOverlayWidget> createState() => _AndroidOverlayState();
}

class _AndroidOverlayState extends State<AndroidOverlayWidget> {
  @override
  void initState() {
    super.initState();
  }
                                ...
                                child: Padding(
                                  ...
                                  child: Card(
                                    ...
                                    child: const Padding(
                                      ...
                                      child: EnvImgWidget(
                                        src: 'demo/android/screen_shortcut.png',
                                      ),
                                    ),
                                  ),
                                ),
