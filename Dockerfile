...
RUN apt-get update && --no-install-recommends apt-get install -y unzip git && apt-get upgrade -y && apt-get clean && rm -rf /var/lib/apt/lists/* /tmp/* /var/tmp/* /var/cache/apt
